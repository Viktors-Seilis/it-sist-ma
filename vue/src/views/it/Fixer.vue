    ...
    <b-row>
      <b-col cols="12">
        ...
        >
          ...
          >
            <p>Pieteikuma izmaiņas tika veiksmīgi saglabātas!</p>
            <b-progress
                variant="success"
                :max="dismissSecs"
          ...
          <b-form @submit="onSubmit" v-if="users && options" enctype="multipart/form-data">
            ...
            >
              ...
              <b-form-input list="departments" disabled v-model="form.departments"></b-form-input>
            ...
            >
              ...
              <b-form-input list="units" disabled v-model="form.units"></b-form-input>
            ...
            >
              ...
              >Nav ievad'its termiņš!</b-form-invalid-feedback>

            </b-form-group>

            <b-form-group
                id="input-group-1"
                label="Labotāja vārds, uzvārds:"
                label-for="input-8"
            >


            <b-form-input id="input-8"
                          list="fixer-list" @input="changeName"
                          model="form.fixer">
            <!--                            :state="validateState('fixer')"-->
            <!--                            aria-describedby="input-1-live-feedback"-->
            </b-form-input>
            <!--              <b-form-invalid-feedback-->
            <!--                  id="input-1-live-feedback"-->
...
export default {
  ...
  methods: {
    ...
    onSubmit(event) {
      ...
      axios.post('/problems/'+this.$route.params.id, jsonToFormData({_method: 'PUT'}, {}, jsonToFormData(this.form))).then(response => {
    ...
    getFormData() {
      axios.get('/problems/'+this.$route.params.id).then(response => {

        let data = response.data.data

        this.form.id = data.id
        this.form.user = data.name + " " + data.surname
        this.form.problem_name = data.problem_name
        this.form.problem_description = data.problem_description
        ...
        this.form.fixer = data.name + " " + data.surname
      })
    },
  },
